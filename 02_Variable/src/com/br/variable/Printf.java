...
public class Printf {
	...
	public void printfTest() {
		/*
		 * print(출력값) : 값 출력만 해줌 (줄바꿈 x)
		 * println([출력값]) : 값 출력 후 줄바꿈 o ([]는 생략가능)
		...
		System.out.printf("%d\n", iNum1, iNum2); // 두번째 값은 무시됨 (오류는 나지 않음)
		//System.out.printf("%d %d", iNum1); // 에러발생 --> 두번째 포맷에 들어갈 값이 없어서
		
		System.out.printf("%5d\n", iNum1); // 5칸의 공간 확보 후 오른쪽 정렬 해서 출력 (음수일 경우는 왼쪽 정렬)
		System.out.printf("%5d\n", 250);
		System.out.printf("%5d\n", 3000);
		System.out.printf("%5d\n", 2);
		...
		System.out.printf("%f %f\n", dNum1, dNum2); // 기본적으로 %f는 무조건 소수점 아래 6째자리까지 표현함
