...
public class InDecrease {
	 ...
	 * < 증감 연산자 (단항 연산자) >
	 * 
	 * ++ : 변수에 담겨있는 값을 1씩 증가시켜주는 연산자
	 *		++변수 | --변수
	 * 
	 * -- : 변수에 담겨있는 값을 1씩 감소시켜주는 연산자
	 * 		--변수 | 변수--
	 * 
	...
	public void method1() {
		// 전위연산테스트
		int num1 = 10;
		System.out.println("전위연산 적용 전 num1 : " + num1);	// num1 = 10
