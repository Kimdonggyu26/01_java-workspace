...
public class AfterMain {
	...
	public static void main(String[] args) {
		 ...
		 * 5. 모든 클래스들은 Object 클래스를 상속받고 있음(즉, 모든 클래스들은 Object 클래스의 하위 클래스)
		 * 	  => 모든 객체들은 Object 클래스 내의 메소드를 사용할 수 있음
		 *    => 모든 클래스에서는 Object 클래스 내의 메소드를 오버라이딩을 통해 재정의 가능
		 */
		...
		d.setAllInOne(false); // Desktop 클래스 메소드 호출
		d.setPrice(2000000); // Product 클래스 메소드 호출
