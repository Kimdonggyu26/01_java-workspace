...
public class ObjectArrayMain4 {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			System.out.println("\n=======폰 판매점========");
			System.out.println("1. 판매점 내의 모든 폼 조회");
			...
			if(menu == 1) {
				...
				int price = pc.searchPhonePrice(phones, search);
				...
				System.out.print("구매하고자 하는 핸드폰(키워드도 가능): ");
				String search = sc.nextLine();
				...
				System.out.println("잘못된 메뉴번호를 입력하셨습니다. 다시 입력 해주세요.");
			}
