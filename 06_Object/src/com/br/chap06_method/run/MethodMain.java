...
public class MethodMain {
	...
	public static void main(String[] args) {
		...
		/*
		ParameterTest pt = new ParameterTest(); // 객체 생성을 해야 해당 객체의 멤버에 접근할 수 있다.
		pt.method1();
		pt.method2(10);
		pt.method3(null);
		pt.method3("홍길동");
		...
		*/
		...
		System.out.println("1부터 100까지의 총합계 : " + rt.method1());
		...
		int[] result = rt.method4(3);	// result는 메소드 내에 생성된 배열객체를 가리킴
		...
		*/
		...
		// static 메소드 호출은
		// 객체 생성을 하지 않아도 클래스명.메소드명(); 으로 호출 가능
